...
$this->title = 'Регистрация перевозчика | Стройсканер';
        ...
        <div class="account">
            <div class="account__content">
                <div class="account__content-top">
                    <div>
                        <p style="text-transform: uppercase">РЕГИСТРАЦИЯ перевозчика</p>
                        <p>В настоящее время доступна регистрация в категориях:<br>
                            песок, щебень, отсев, ПЩС<br>
                            что бы стать поставщиком сервиса, если вы Юр. лицо или ИП, нужно иметь
                        </p>
                        <ol>
                            <li>ОКВЭД 49.41, 49.41.1, 49.41.3, 49.42, 52.29 основным или дополнительным (обязательно)</li>
                        </ol>
                        <p>Если физическое лицо, поставьте галочку в первом разделе и выберите варианты доставки</p>
                    </div>
                    <div>
                ...
                <form method="post" id="registration">
                    ...
                    <div class="material__editing-block">
                        ...
                        <div class="material__input material__input-50">
                            ...
                            <div>
                                <div class="mm2-1 material__input-block">
                                    <div class="button__check">
                                        <label>
                                            <input type="checkbox" name="fio-check" class="checkbox__1-block fio-checkbox">
                                            <span class="checkbox__1">
                                                 <svg xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 12 11" fill="none">
                                                    <path d="M1 5.5L4.33333 10L11 1" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                </svg>
                                    ...
                                    <label>
                                        <input class="w-100" type="text" name="fio" placeholder="ФИО (для физических лиц, поставьте галочку)">
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="m3  material__input-block">
                                    ...
                                    <select name="quarries[0][name]">
                                        ...
                                        <option value="Напрямую с карьера">Напрямую с карьера</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="d-flex db1">
                                    <div class="w-50 d1">
                                        <span>(Доставка продукции с карьеров поставщиков города Тюмени и ближайших районов)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
