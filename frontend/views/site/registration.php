...
$this->title = 'Регистрация производителя | Стройсканер';
...
<div class="header__head border__top">
    <div class="container">
        <p>Регистрация производителя (карьер)</p>
    </div>
</div>
        ...
        <div class="account">
            <div class="account__content">
                <div class="account__content-top">
                    <div>
                        <p style="text-transform: uppercase">РЕГИСТРАЦИЯ производителя</p>
                            ...
                            <div>
                                <div class="m3  material__input-block">
                                    ...
                                    <select name="quarries[0][name]">
                                        <option value="Щебеночный карьер">Щебеночный карьер</option>
                                        <option value="Песчаный карьер">Песчаный карьер</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="d-flex db1">
                                    <div class="w-50 d1">
                                        <span>Действующий карьер, на правах собственности или аренды, с которого вы отгружаете продукцию самовывозом или с доставкой. Доставка только своим транспортом в собственности или аренде)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
